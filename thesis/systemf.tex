...
For instance, we need to prove that the extension of a substitution \Data{extₛ}, that itself uses renaming under the hood, is type preserving. Thus, we also need to prove that renamings are type preserving.
