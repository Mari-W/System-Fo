...
\noindent Similar to variables, terms can be weakened by shifting all variables present in the term by one using the \Data{ren} function. 
\Fwk 
The \Data{wkᵣ} function wraps all variables in the original renaming in an additional \Constr{there}.
\Frenwk
