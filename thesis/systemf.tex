...
Going forward, we will use the variable \Sym{r} for elements of type \Data{Bindable}, the variable \Sym{s} for elements of type \Data{Sort} and the variable \Sym{S} for lists of bindable sorts of type \FSorts.
