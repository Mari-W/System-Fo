...
Additional complexity arises because we need to deal with the fact that constraints were ignored by the \Data{lookup} method in System \Fo\ but then are translated to actual context items in System F.
