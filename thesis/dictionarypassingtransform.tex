...
In consequence, all bindings for overloaded variables translate to normal expression bindings in System F and the sort \Constr{oₛ} needs to translate to \Constr{eₛ}.
