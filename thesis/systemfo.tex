...
Analogous to the type \Sym{τ'} inside the abstraction rule \Constr{⊢λ}, the resulting type \Sym{τ} cannot use the introduced overloaded variable and thus is weakened to align in \Sym{S} with \Sym{Γ}. In consequence, \Sym{τ} can act as the resulting type of the typing.
