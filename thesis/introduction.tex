...
A invocation of an overloaded function name \mono{o} translates to the correct unique variable name \mono{o$_τ$} that is bound by the let binding that got introduced for the resolved instance at the given invocation. 
