...
\noindent A little caveat: the second instance needs to recursively call \mono{eq} for sublists but System \Fo's formalization does not actually support recursive recursive let bindings or recursive instances. Extending System \Fo\ recursive let bindings or instances should be straight forward but is subject to further work.
